...
<div class="max-w-3xl space-y-8">
  <!-- Header -->
  <div>
    <h1 class="text-lg font-medium mb-1">Settings</h1>
  ...
  <form onsubmit={handleSubmit} class="space-y-12">
    ...
    <div class="space-y-5">
      <h2 class="text-base font-medium pb-2 border-b border-gray-200">Personal Information</h2>

      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          <label for="fullName" class="block text-sm text-gray-500 mb-1.5">Full Name</label>
          <input
            id="fullName"
            type="text"
            bind:value={fullName}
        ...
        <div>
          <label for="defaultCurrency" class="block text-sm text-gray-500 mb-1.5">Default Currency</label>
          <select
            id="defaultCurrency"
    ...
    <div class="space-y-5">
      ...
      <div class="flex items-center gap-2">
        ...
        />
        <label for="operatesAsCompany" class="text-sm text-gray-700 cursor-pointer">
          I operate as a registered business/company
        </label>
      </div>

      <div>
        <label for="companyName" class="block text-sm text-gray-500 mb-1.5">
      ...
      <div>
        <label for="companyAddress" class="block text-sm text-gray-500 mb-1.5">Company Address</label>
        <textarea
          id="companyAddress"
      ...
      <div>
        <label for="taxId" class="block text-sm text-gray-500 mb-1.5">Tax ID / VAT Number</label>
        <input
          id="taxId"
          type="text"
          bind:value={taxId}
    ...
    <!-- Bank Details -->
    <div class="space-y-5">
      <h2 class="text-base font-medium pb-2 border-b border-gray-200">Bank Transfer Details</h2>

      <div>
        <label for="bankDetails" class="block text-sm text-gray-500 mb-1.5">Bank Information</label>
        <textarea
          id="bankDetails"
    ...
    <div class="flex justify-end pt-4">
      <button
        type="submit"
        disabled={isLoading}
        class="px-5 py-2.5 bg-black text-white text-sm hover:bg-gray-800 transition-colors duration-75 disabled:opacity-50"
      >
  ...
  <div class="space-y-12 mt-12">
    <div class="space-y-5">
      <div class="flex items-center justify-between pb-2 border-b border-gray-200">
        <h2 class="text-base font-medium">Custom Template Fields</h2>
        <button
          type="button"
          onclick={() => { showCustomFieldForm = !showCustomFieldForm; customFieldLabel = ''; }}
          class="px-5 py-2.5 text-sm bg-black text-white hover:bg-gray-800 transition-colors"
        >
      ...
      {#if showCustomFieldForm}
        <div class="border border-gray-300 rounded-sm p-4 bg-gray-50">
          ...
          >
            <div>
              <label for="field_label" class="block text-sm text-gray-500 mb-1.5">
                Field Label
              </label>
              <input
                id="field_label"
                ...
                class="w-full px-4 py-2.5 text-sm border border-gray-300 focus:outline-none focus:border-black"
                required
              />
            </div>
            ...
            <div class="flex gap-2">
              <button
                ...
                class="px-5 py-2.5 bg-black text-white text-sm hover:bg-gray-800 transition-colors disabled:opacity-50"
              >
        ...
        <div class="border border-gray-200 rounded-sm divide-y divide-gray-200">
          {#each data.customFields as field}
            <div class="flex items-center justify-between p-3 hover:bg-gray-50 transition-colors">
              <div>
                <div class="text-sm font-medium">{field.field_label}</div>
                <div class="text-sm text-gray-500 mt-0.5">
                  <code class="font-mono text-sm bg-gray-100 px-1 py-0.5 rounded">{field.field_name}</code>
                </div>
              </div>
              ...
              >
                ...
                <button
                  type="submit"
                  class="text-sm text-red-600 hover:text-red-800 hover:bg-red-50 px-2 py-1 rounded-sm transition-colors"
                >
                  Delete
                </button>
              </form>
  ...
  <div class="space-y-12 mt-12">
    <div class="space-y-5">
      <h2 class="text-base font-medium pb-2 border-b border-gray-200">Account</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          <label class="block text-sm text-gray-500 mb-1.5">Plan</label>
          <div class="px-4 py-2.5 text-sm border border-gray-300 bg-gray-50 text-gray-500">
